      ...
      <?php foreach ($this->logs AS $log): ?>
       <tr class="list" >
        ...
        <?php elseif (isset($log['kill_gametime'])): ?>
         ...
         <td class="playername"><?php if (!empty($log['killer_id'])): ?><a href="player_details.php?player_id=<?php echo $log['killer_id']; ?>"><?php echo replace_color_codes(htmlspecialchars($log['killer_name'])) ?></a><? endif; ?></td>
         ...
         <td><?php if (!empty($log['victim_id'])): ?><a href="player_details.php?player_id=<?php echo $log['victim_id']; ?>"><?php echo replace_color_codes(htmlspecialchars($log['victim_name'])) ?></a><? endif; ?><?php if (empty($log['weapon_icon'])): ?> died by <?php echo $log['weapon_name']; endif;?></td>

        <?php elseif (isset($log['destruct_gametime'])): ?>
         <td><?php echo $log['destruct_gametime'] ?></td>
         <td class="playername"><?php if (!empty($log['player_id'])): ?><a href="player_details.php?player_id=<?php echo $log['player_id']; ?>"><?php echo replace_color_codes(htmlspecialchars($log['player_name'])) ?></a><? endif; ?></td>
         <td><?php if (!empty($log['weapon_icon'])): ?><img src="images/icons/<?php echo $log['weapon_icon']; ?>" alt="<?php echo $log['weapon_name']; ?>" <?php list($width, $height, $type, $attr) = getimagesize('images/icons/'.$log['weapon_icon']); echo $attr; ?>><<?php else: ?>$log['weapon_name']<?php endif; ?>/td>
        ...
        <?php elseif (isset($log['vote_gametime'])): ?>
         ...
         <td class="playername"><?php if (!empty($log['caller_id'])): ?><a href="player_details.php?player_id=<?php echo $log['caller_id']; ?>"><?php echo replace_color_codes(htmlspecialchars($log['caller_name'])) ?></a><? endif; ?></td>
         <td></td>
         ...
         <td>
          ...
          <?php if (!empty($log['victim_id'])): ?><a href="player_details.php?player_id=<?php echo $log['victim_id']; ?>"><?php echo replace_color_codes(htmlspecialchars($log['victim_name'])) ?></a><? endif; ?>
