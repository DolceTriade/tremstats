  ...
  <table>
    ...
    <thead>
      <tr>
        ...
        <th title="Average Kills to Enemy per Round"><?php echo custom_sort('Average Kills',     'average_kills'); ?></a></th>
        <th title="Average Kills to Team per Round"><?php echo custom_sort('Average Team Kills', 'average_team_kills'); ?></th>
